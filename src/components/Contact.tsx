  ...
  return (
    <section className="px-6 py-16 md:py-0 w-full max-w-4xl mx-auto" ref={ref}>
      ...
      >
        ...
        <motion.h2 variants={item} className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 relative">
          Let&apos;s build together
        </motion.h2>
        <motion.p variants={item} className="text-[#94a3b8] text-base sm:text-lg leading-relaxed max-w-md mb-10 relative">
          Open to contributions, collaborations, and interesting projects in
          AI infrastructure.
        </motion.p>

        <motion.div variants={item} className="flex flex-col sm:flex-row gap-3 relative">
          <a
          ...
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-[#94a3b8]" aria-hidden="true">
